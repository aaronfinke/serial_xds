...
def gen_xds_text(UNIT_CELL_CONSTANTS, SPACE_GROUP_NUMBER, NAME_TEMPLATE_OF_DATA_FRAMES, 
				ORGX, ORGY, DETECTOR_DISTANCE, OSCILLATION_RANGE, 
				X_RAY_WAVELENGTH, DATA_RANGE, BACKGROUND_RANGE, SPOT_RANGE, LIB):
...
NUMBER_OF_PROFILE_GRID_POINTS_ALONG_GAMMA=13
    ...
    in_10=SPOT_RANGE, in_11=LIB, in_12=SPACE_GROUP_NUMBER)
    return text
